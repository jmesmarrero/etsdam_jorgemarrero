...
|:-----------------------:|:-------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
|         Usuario         | Usuarios que pueden interactuar directamente con la app |                                                Iniciar sesión, modificar perfil.  consultar la disponibilidad de una instalación para un día y franja horaria concreta                                                |
|          Admin          |       Admin que puede manejar la app internamente       | puede añadir nuevas instalaciones deportivas, modificar sus datos o desactivarlas temporalmente.El administrador también puede consultar un listado de usuarios y bloquear a aquellos que incumplan las normas de uso. |
