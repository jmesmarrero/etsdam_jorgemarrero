...
![cobertura_test](img/cobertura2.png)
![cobertura_test](img/cobertura3.png)

### Reflexión final

+ ¿Qué partes del código no estaban cubiertas?
1. Cuando la lista está vacía
2. Cuando una nota está fuera del rango 0–10


+ ¿Qué tests has añadido?
1. - testListaVacia() para comprobar que se lanza la excepción “Lista vacía”.
2. - testNotaFueraDeRango() para comprobar que se lanza la excepción “Nota fuera de rango”.
+ ¿Qué cobertura final has obtenido?
1. Con los nuevos test llegamos a un 90% de cobertura.
